...
public class ProjectSharingData implements Iterable<IReferencePoint> {
   ...
   *
   * @param referencePoint project that should be shared
   * @param referencePointID session-wide ID assigned to the project
   ...
   * (which, if true, can be queried with {@link #getResourcesToShare(IReferencePoint)}.
   *
